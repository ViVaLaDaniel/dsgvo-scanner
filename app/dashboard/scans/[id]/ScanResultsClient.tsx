...
interface ScanResultsClientProps {
  scan: Scan & { website: Website | any }; // ensuring website is included
  agency: Agency | null;
}

export default function ScanResultsClient({ scan, agency }: ScanResultsClientProps) {
  const router = useRouter();
  const website = scan.website as Website;
    ...
    <div className="space-y-8 animate-in fade-in duration-700 relative pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 no-print">
        ...
        <div className="flex gap-3">
          <DownloadReportButton scanId={scan.id} className="font-bold" />
          <SendReportModal
            scanId={scan.id}
