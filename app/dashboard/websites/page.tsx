...
import { Plus, Globe, Trash2, Play, ExternalLink, ShieldCheck, AlertCircle, RefreshCw } from 'lucide-react';
        ...
        {isLoadingData ? (
          ...
          <Card className="border-dashed border-2 border-slate-200 bg-slate-50/50">
            <CardContent className="text-center py-20">
              ...
              <div className="mt-6">
                <Button onClick={() => setShowAddForm(true)} className="font-bold shadow-lg shadow-blue-500/20">
                  <Plus className="h-4 w-4" />
                  Jetzt Website hinzufügen
                </Button>
              </div>
            </CardContent>
          </Card>
